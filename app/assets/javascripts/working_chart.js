      ...
      function stopAnimation(value) {
        ...
        const countdownInterval = setInterval(() => {
          ...
          if (countdown === 0) {
            ...
            animationDuration = randompick[Math.floor(Math.random() * randompick.length)]; // Set a new random duration
            startAnimation();
        ...
        $.ajax({
    type: 'POST',
    url: 'http://localhost:3000/bets/save_burst_data', // Update the URL as needed
    data: {
